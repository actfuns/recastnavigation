...
|------|-------------:|-------:|-----------:|--------:|
| **FindPath** (5 格) | 585 | ×1.14 | 0 | 0 |
| **FindPath** (10 格) | 1,183 | ×1.05 | 0 | 0 |
| **FindPath** (19 格) | 2,222 | ×1.01 | 0 | 0 |
| **FindStraightPath** (39 多边形路径) | 838 | ×1.16 | 0 | 0 |
| **Raycast** (5 格) | 181 | ×0.46 | 0 | 0 |
| **Raycast** (10 格) | 389 | ×0.51 | 0 | 0 |
| **Raycast** (19 格) | 712 | ×0.52 | 0 | 0 |
| **FindPolysAroundCircle** (r=50) | 11,902 | ×1.16 | 0 | 0 |
| **FindPolysAroundCircle** (r=100) | 32,908 | ×0.84 | 0 | 0 |
| **FindPolysAroundCircle** (r=150) | 37,126 | — | 0 | 0 |

### 导航网格构建

| 网格规模 | 多边形数 | 耗时 (ns/op) | 分配 (B/op) |
|---------|--------:|------------:|-----------:|
| 10×10 | 200 | 16,483 | 48,008 |
| 50×50 | 5,000 | 377,830 | 1,163,641 |
| 100×100 | 20,000 | 1,866,748 | 4,571,518 |
